<template>
  <div style="width: 100%;">
    <div class="container">
      <div
        class="row position"
        style="padding-left: 0px; padding-right: 0px; margin-left: 0px; margin-right: 0px; width: 100%; margin-top: 100px;"
      >
        <div
          class="cover-img"
          style="padding-left: 0px; padding-right: 0px; margin-left: 0px; margin-right: 0px; width: 100%; height: 80%; z-index: -1; margin-top: 0px;"
        ></div>
        ...
        <div
          ...
          style=" padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 40px;"
        >
      ...
      <div class="position" style="height: 50px; background: #ffffff;"></div>
      ...
      <div class="position div-spacing row nopadding" style="background: #ffffff;">
        <div class="col-md-6">
          ...
          <p
            class="lead"
          >Have fun browsing through, and let me know if you find anything interesting!</p>
        </div>
        <div class="col-md-6 prof-container">
          ...
          >
            <div class="row nopadding" style="text-align: center;">
              <div class="col-md-3" style="border-right: 1px solid #eeeeee">
                <p
                  style="font-weight: 550; font-size: 22px; color: #9400D3; padding-top: 10px;"
                >Today</p>
                <p
                  style="font-weight: 300; font-size: 14px; color: #ffffff; border-radius: 10px 10px 10px 10px; background-color: #9400D3;"
                >Work</p>
              </div>
              <div class="col-md-6">
                <p
              ...
              <div
                class="col-md-3"
                style="background: #9400D3; padding-top: 0px; padding-bottom: 0px; margin-top: 0px; margin-bottom: 0px; height: 100%;"
              >
                <p
                  style="font-size: 42px; margin-bottom: 0px; color: #ffffff;"
                >{{ new Date().getDate() }}</p>
            ...
            <div class="row nopadding" style="text-align: center;">
              <div class="col-md-12 nopadding" style="width: 100%; height: 200px;">
                <GmapMap
                  :center="{lat: 38.3141088, lng: 26.6340546}"
                  :zoom="16"
                  map-type-id="terrain"
          ...
          >
            <div class="row nopadding" style="text-align: center;">
              <div class="col-md-3" style="border-right: 1px solid #eeeeee">
                <p
                  style=" float: left; font-weight: 550; font-size: 22px; color: #9400D3; padding-top: 10px;"
                >{{dateDifference(new Date("1/16/2019"), new Date())}}</p>
      ...
      <div
        class="album py-5"
        style=" background-image: url('/background2.jpeg'); background-position: center; background-size: cover; background-repeat: no-repeat; position: relative;"
      >
...
export default {
  ...
  data() {
    return {
      ...
      error: '',
      text: '',
      markers: [{ position: { lat: 38.3141088, lng: 26.6340546 } }]
    }
  },
  async created() {
    try {
